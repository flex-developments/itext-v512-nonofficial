 ...
 * 
 * Fuente original: http://itextpdf.com/
 * ---
 * Modificada en 2013 por Superintendencia de Servicios de Certificación Electrónica (SUSCERTE):
...
//******************************************************************************
    ...
    public java.io.OutputStream getOriginalout() {
        return originalout;
    }
    ...
    public void preClose(HashMap<PdfName, Integer> exclusionSizes) throws IOException, DocumentException {
        ...
        if (fieldExists) {
            ...
            //Pasa por aqui aunq el archivo existe y lo debe sobreescrbir
